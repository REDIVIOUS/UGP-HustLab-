...
proc create_root_design { parentCell } {
  ...
  set DIS_SENSOR [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 DIS_SENSOR ]
  ...
  set_property -dict [ list CONFIG.C_ALL_INPUTS_2 {1} CONFIG.C_ALL_OUTPUTS {1} CONFIG.C_GPIO2_WIDTH {16} CONFIG.C_GPIO_WIDTH {16} CONFIG.C_IS_DUAL {0}  ] $axi_gpio_0
  ...
  connect_bd_intf_net -intf_net axi_iic_1_IIC [get_bd_intf_ports DIS_SENSOR] [get_bd_intf_pins axi_iic_1/IIC]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x10B00000 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/ahblite] [get_bd_addr_segs axi_iic_1/S_AXI/Reg] SEG_axi_iic_1_Reg
